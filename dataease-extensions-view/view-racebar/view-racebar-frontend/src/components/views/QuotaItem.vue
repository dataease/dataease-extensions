      ...
      <span class="el-dropdown-link">
        <el-tag size="small" class="item-axis" :type="tagType">
          <span style="float: left">
            ...
            <svg-icon v-if="chart.type ==='race-bar' && item.chartType === 'bar'" icon-class="bar"
                      class-name="field-icon-sort"/>
            <svg-icon v-if="chart.type ==='race-bar' && item.chartType === 'line'" icon-class="line"
                      class-name="field-icon-sort"/>
            <svg-icon v-if="chart.type ==='race-bar' && item.chartType === 'scatter'" icon-class="scatter"
                      class-name="field-icon-sort"/>
